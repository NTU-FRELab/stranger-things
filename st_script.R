...
## DW, AFDW, OM AND IM
#wo:weight_filter,
#w1:weight_filter_1mL_tissue
#w2:weight_filter_1mL_tissue_ashed
#w3:weight_tube
#w4:weight_tube_1mL_tissue_bleached
...
prot.host.1=sf$STCHX4*abs.prot.host1.corr^4+sf$STCHX3*abs.prot.host1.corr^3+sf$STCHX2*abs.prot.host1.corr^2+sf$STCHX1*abs.prot.host1.corr+sf$STCHE # conc.host1.SDS (ug mL-1)
prot.host.2=sf$STCHX4*abs.prot.host2.corr^4+sf$STCHX3*abs.prot.host2.corr^3+sf$STCHX2*abs.prot.host2.corr^2+sf$STCHX1*abs.prot.host2.corr+sf$STCHE # conc.host2.SDS (ug mL-1)
prot.host.3=sf$STCHX4*abs.prot.host3.corr^4+sf$STCHX3*abs.prot.host3.corr^3+sf$STCHX2*abs.prot.host3.corr^2+sf$STCHX1*abs.prot.host3.corr+sf$STCHE # conc.host3.SDS (ug mL-1)
