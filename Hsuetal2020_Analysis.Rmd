---
title: "Stranger things: organismal traits of two octocorals associated with singular Symbiodiniaceae in a high-latitude coral community from northern Taiwan"
author: "Hsu et al."
date: "2020/12/07"
output: 
  html_document:
...
knitr::purl("Hsuetal2020_Analysis.Rmd", documentation = F)
```
...
H: coral host; A: algae; C.N: carbon to nitrogen ratio
...
wo:weight of filter; w1:weight of filter + 1mL tissue; w2:weight of filter + 1mL tissue (ashed); w3:weight of tube; w4:weight of tube + 1mL tissue (bleached)
...
## Algal symbiont content

zX_X:cell counting 5 x 1 mm2 repeated five time; dil:dilution 
...
w0_l: dish; wt_l: dish + total sample; w1_l: dish + subsample; wplate0: dish
; wplate1: dish + lipid
